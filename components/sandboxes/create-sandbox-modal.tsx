...
export function CreateSandboxModal({
  ...
  useEffect(() => {
    if (formData.sourceAppId && activeTab === "clone") {
      const selectedApp = syncedApps.find(
        (a: any) => a.id === formData.sourceAppId
      );
      if (selectedApp) {
        setCloneInfo({
    ...
    try {
      ...
      if (activeTab === "link") {
        ...
        const selectedEnv = powerAppsEnvironments?.find(
          (env: any) => env.name === formData.environmentId
        );
      ...
      <DialogContent className="sm:max-w-[600px] bg-slate-800 border-slate-700">
        <DialogHeader>
          ...
          <DialogDescription className="text-slate-400">
            Create a new sandbox environment to build and test your low-code
            applications
          </DialogDescription>
        </DialogHeader>
            ...
            <TabsContent value="new" className="space-y-4 mt-4">
              ...
              {formData.platform === SandboxPlatform.MENDIX && (
                <Alert className="bg-amber-500/10 border-amber-500/50">
                  ...
                  <AlertDescription className="text-amber-200 text-sm">
                    <strong>Note:</strong> Creating new Mendix apps via API may
                    require additional permissions. We recommend selecting an
                    existing app from the <strong>"Clone Existing"</strong> tab,
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handlePlatformSelect(value as SandboxPlatform)
                  }
                >
                  <SelectTrigger
                  ...
                  <SelectContent className="bg-slate-700 border-slate-600">
                    <SelectItem
                      value={SandboxPlatform.POWERAPPS}
                      className="text-white hover:bg-slate-600"
                    >
                      ⚡ Microsoft PowerApps
                    </SelectItem>
                    <SelectItem
                      value={SandboxPlatform.MENDIX}
                      className="text-white hover:bg-slate-600"
                    >
                      🔷 Mendix
                    </SelectItem>
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent className="bg-slate-700 border-slate-600">
                    <SelectItem
                      value={SandboxType.PERSONAL}
                      className="text-white hover:bg-slate-600"
                    >
                      Personal - For individual development
                    </SelectItem>
                    <SelectItem
                      value={SandboxType.TEAM}
                      className="text-white hover:bg-slate-600"
                    >
                      Team - Shared with team members
                    </SelectItem>
                    <SelectItem
                      value={SandboxType.TRIAL}
                      className="text-white hover:bg-slate-600"
                    >
            ...
            <TabsContent value="link" className="space-y-4 mt-4">
              ...
              <Alert className="bg-blue-500/10 border-blue-500/50">
                ...
                <AlertDescription className="text-blue-200 text-sm">
                  <strong>Link Existing Environment:</strong> Connect your
            ...
            <TabsContent value="clone" className="space-y-4 mt-4">
              ...
              {formData.platform === SandboxPlatform.MENDIX && (
                <Alert className="bg-blue-500/10 border-blue-500/50">
                  ...
                  <AlertDescription className="text-blue-200 text-sm">
                    <strong>Mendix Sandbox:</strong> This will use the selected
                    app's free environment as your sandbox. Mendix does not
                    support app cloning via API. To create a true copy, please
                    duplicate the app in Mendix Portal first.
                  </AlertDescription>
                </Alert>
              )}
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => {
                    setFormData((prev) => ({
                      ...prev,
                      platform: value as SandboxPlatform,
                      sourceAppId: "",
                    }));
                    setErrors((prev) => ({
                      ...prev,
                ...
                {appsLoading ? (
                  ...
                  <>
                    ...
                    >
                      <SelectTrigger
                        className={`bg-slate-700 border-slate-600 text-white ${
                          errors.sourceApp ? "border-red-500" : ""
                        }`}
                      >
              ...
              {cloneInfo && (
                <div className="space-y-3">
                  <Alert className="bg-slate-700 border-slate-600">
                    ...
                    <AlertDescription className="text-slate-300">
                      <div className="space-y-1">
                        ...
                        <div className="text-sm text-slate-400">
                          • New sandbox will be named:{" "}
                          <span className="text-blue-400">
                            "Sandbox -{" "}
                            {formData.name.trim() || cloneInfo.appName}"
                          </span>
                        </div>
                        <div className="text-sm text-slate-400">
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-xs text-slate-400">
                      Leave empty to use the original app name. "Sandbox - "
