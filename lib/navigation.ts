...
export const ROLE_NAVIGATION: Record<UserRole, RoleNavigation> = {
  admin: {
    ...
    defaultPath: '/admin',
    navItems: [
      { label: 'Dashboard', href: '/admin', description: 'Overview and analytics' },
      { label: 'Policies', href: '/admin/policies', description: 'Manage governance policies' },
      { label: 'Compliance', href: '/admin/compliance', description: 'Compliance reports' },
      { label: 'Connectors', href: '/admin/connectors', description: 'Platform integrations' },
  ...
  'citizen-developer': {
    ...
    navItems: [
      { label: 'Sandbox', href: '/citizen-developer', description: 'Build and test apps' },
      { label: 'Changes', href: '/citizen-developer/changes', description: 'Track my changes' },
      { label: 'Learning', href: '/citizen-developer/learning', description: 'Tutorials and resources' },
      { label: 'Review', href: '/citizen-developer/review', description: 'Review requests' },
    ],
  },
  'pro-developer': {
    role: 'pro-developer',
    ...
    navItems: [
      { label: 'Dashboard', href: '/pro-developer', description: 'Review queue and metrics' },
      { label: 'Review', href: '/pro-developer/review', description: 'Review submissions' },
      { label: 'Pipelines', href: '/pro-developer/pipelines', description: 'CI/CD pipelines' },
      { label: 'History', href: '/pro-developer/history', description: 'Change history' },
      { label: 'Audit', href: '/pro-developer/audit', description: 'Audit logs' },
    ],
  },
};
 ...
 */
export function isPathActive(currentPath: string, navItemPath: string): boolean {
  // Exact match
