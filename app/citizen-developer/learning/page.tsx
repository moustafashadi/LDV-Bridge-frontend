...
export default function LearningHub() {
  ...
  const bestPractices = [
    ...
    },
    {
      ...
      description:
        "Always test your changes in the sandbox before submitting for review",
    },
    {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Use the 'Undo Last Change' button in the sandbox, or 'Discard All Changes' to start fresh.",
    },
    {
  ...
  return (
    <RoleLayout>
      <PageHeader
        title="Learning Hub"
        description="Self-service education and best practices"
      />
